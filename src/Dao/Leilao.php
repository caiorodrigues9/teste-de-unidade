...
namespace Caio\Leilao\Dao;

use Caio\Leilao\Infra\ConnectionCreator;
use Caio\Leilao\Model\Leilao as ModelLeilao;
...
class Leilao
{
    ...
    public function salva(ModelLeilao $leilao): ModelLeilao
    {
        ...
        $stm->bindValue(2, $leilao->leilaoEstaFinalizado(), \PDO::PARAM_BOOL);
    ...
    public function atualiza(ModelLeilao $leilao)
    {
        ...
        $stm->bindValue(':finalizado', $leilao->leilaoEstaFinalizado(), \PDO::PARAM_BOOL);
